...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Fetch the auto-login URL containing apiToken for a node.
      url: '#fetch-the-auto-login-url-containing-apitoken-for-a-node'
    - depth: 2
    ...
    - depth: 2
      title: Restart panel and Xray core on an online remote node.
      url: '#restart-panel-and-xray-core-on-an-online-remote-node'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Fetch the auto-login URL containing apiToken for a node.
        id: fetch-the-auto-login-url-containing-apitoken-for-a-node
      ...
      - content: Restart panel and Xray core on an online remote node.
        id: restart-panel-and-xray-core-on-an-online-remote-node
