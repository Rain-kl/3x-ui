...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Fetch proxy outbounds configured in the template config on this node for
        cross-node outbound synchronization.
      url: '#fetch-proxy-outbounds-configured-in-the-template-config-on-this-node-for-cross-node-outbound-synchronization'
    - depth: 2
      title: Replace proxy outbounds in the template config on this node and apply
        changes to Xray.
      url: '#replace-proxy-outbounds-in-the-template-config-on-this-node-and-apply-changes-to-xray'
    - depth: 2
      title: Fetch all outbound tags from the template config on this node, including
        system outbounds, for cross-node outbound management.
      url: '#fetch-all-outbound-tags-from-the-template-config-on-this-node-including-system-outbounds-for-cross-node-outbound-management'
    - depth: 2
      title: Fetch routing rules configured in the template config on this node.
      url: '#fetch-routing-rules-configured-in-the-template-config-on-this-node'
    - depth: 2
      title: Replace routing rules in the template config on this node and apply
        changes to Xray.
      url: '#replace-routing-rules-in-the-template-config-on-this-node-and-apply-changes-to-xray'
  structuredData:
    headings:
      ...
      - content: Fetch proxy outbounds configured in the template config on this node
          for cross-node outbound synchronization.
        id: fetch-proxy-outbounds-configured-in-the-template-config-on-this-node-for-cross-node-outbound-synchronization
      - content: Replace proxy outbounds in the template config on this node and apply
          changes to Xray.
        id: replace-proxy-outbounds-in-the-template-config-on-this-node-and-apply-changes-to-xray
      - content: Fetch all outbound tags from the template config on this node,
          including system outbounds, for cross-node outbound management.
        id: fetch-all-outbound-tags-from-the-template-config-on-this-node-including-system-outbounds-for-cross-node-outbound-management
      - content: Fetch routing rules configured in the template config on this node.
        id: fetch-routing-rules-configured-in-the-template-config-on-this-node
      - content: Replace routing rules in the template config on this node and apply
          changes to Xray.
        id: replace-routing-rules-in-the-template-config-on-this-node-and-apply-changes-to-xray
    contents: []
---
