...
bash <(curl -Ls https://raw.githubusercontent.com/Rain-kl/3x-ui/main/install.sh) v3.4.0
```
...
[страницы релизов](https://github.com/Rain-kl/3x-ui/releases), распаковать его и
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/Rain-kl/3x-ui/main/install.sh)
```
